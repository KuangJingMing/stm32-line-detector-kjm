...
void setup_scr_scrSetting(lv_ui *ui)
{
    ...
    ui->scrSetting_cont_1 = lv_obj_create(ui->scrSetting_cont_log);
    lv_obj_set_pos(ui->scrSetting_cont_1, 0, 0);
    lv_obj_set_size(ui->scrSetting_cont_1, 712, 347);
    ...
    lv_obj_set_style_bg_opa(ui->scrSetting_cont_1, 0, LV_PART_MAIN|LV_STATE_DEFAULT);
    ...
    ui->scrSetting_list_3 = lv_list_create(ui->scrSetting_cont_1);
    ...
    lv_obj_set_pos(ui->scrSetting_list_3, 44, 32);
    lv_obj_set_size(ui->scrSetting_list_3, 611, 162);
    ...
    ui->scrSetting_sw_1 = lv_switch_create(ui->scrSetting_cont_1);
    lv_obj_set_pos(ui->scrSetting_sw_1, 525, 52);
    lv_obj_set_size(ui->scrSetting_sw_1, 58, 25);
    ...
    ui->scrSetting_ta_8 = lv_textarea_create(ui->scrSetting_cont_1);
...
#endif
    lv_obj_set_pos(ui->scrSetting_ta_8, 525, 108);
    ...
    lv_obj_set_style_radius(ui->scrSetting_ta_8, 20, LV_PART_MAIN|LV_STATE_DEFAULT);
    ...
    ui->scrSetting_btn_3 = lv_btn_create(ui->scrSetting_cont_1);
    ...
    lv_obj_set_pos(ui->scrSetting_btn_3, 63, 236);
    lv_obj_set_size(ui->scrSetting_btn_3, 200, 50);
    ...
    ui->scrSetting_btn_4 = lv_btn_create(ui->scrSetting_cont_1);
    ...
    lv_obj_set_pos(ui->scrSetting_btn_4, 440, 236);
    lv_obj_set_size(ui->scrSetting_btn_4, 200, 50);
