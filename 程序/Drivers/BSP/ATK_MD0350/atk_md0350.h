...
/* 引脚定义 */
#define ATK_MD0350_BL_GPIO_PORT         GPIOH
#define ATK_MD0350_BL_GPIO_PIN          GPIO_PIN_9
#define ATK_MD0350_BL_GPIO_CLK_ENABLE() do{ __HAL_RCC_GPIOH_CLK_ENABLE(); }while(0)
